...
public class MyVaadinUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        final HorizontalSplitPanel horSplitPan = new HorizontalSplitPanel();
        horSplitPan.setSplitPosition(20, Unit.PERCENTAGE);
        horSplitPan.setFirstComponent(new ComponentCollection());
        setContent(horSplitPan);
    }
